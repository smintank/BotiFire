...
import lexicon.lexicon_ru as msg
import errors.errors as error
...
def validate_data(parsed_person: [str]) -> [str]:
    ...
    if db_results is None or not db_results:
        raise error.NotCorrectMessage(msg.NAME_CHECK_ERROR_MESSAGE)
    ...
    if match and len(match) == 1:
        ...
        raise error.NotCorrectMessage(msg.SURNAME_CHECK_ERROR_MESSAGE)
